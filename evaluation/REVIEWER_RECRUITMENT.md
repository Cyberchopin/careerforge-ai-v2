...
| Channel | Concrete ask | Independence check |
| --- | --- | --- |
| **A. External senior engineer through the owner's professional/alumni network** (direct email or LinkedIn) | Ask one engineer who has not built CareerForge to review a blinded packet of synthetic résumé evidence and candidate claims, record support judgments and rationale, and flag ambiguous wording. Budget ~60–90 minutes. | No CareerForge contributor, no access to system outputs, no financial stake in a favorable result. |
| **B. University CS/ML instructor, TA, or research-methods mentor outside the project** (department office hours or direct email) | Ask one independent reviewer to check the same packet and the source-evidence sufficiency, with special attention to quantified and leadership claims. Budget ~60–90 minutes. | Not an author of the dataset or scoring rules; blinded to model arms and predictions. |

## Deadlines and decision rule
...
Owner action required: choose actual people, send invitations, and confirm availability. This document does **not** imply that invitations were sent.
